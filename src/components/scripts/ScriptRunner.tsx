...
//
// Ein Modus, für beide Skripte derselbe: Überschrift, ausformulierte Fragen
// (block.hint) und ein Notizfeld je Block, Autosave beim Blur, Fortschritt
// oben. Das Skript ist während des Calls der Leitfaden — es wird abgelesen
// UND mitgeschrieben.
//
// Historie, damit es nicht ein zweites Mal passiert: Es gab kurzzeitig einen
// zweiten Modus "outline", der nur die nummerierten Überschriften zeigte
// (Vorgabe „Nimm das Skript raus. Einfach nur die Überschriften lassen").
// Damit fielen im Setting die Fragen und sämtliche Eingabefelder weg — man
// konnte zu den einzelnen Schritten nichts mehr notieren. Der Modus ist
// wieder entfernt; wer das Gerüst pur will, klappt Blöcke ein, statt die
// Eingabe zu streichen.
