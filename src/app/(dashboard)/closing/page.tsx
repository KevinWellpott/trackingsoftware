import { ClosingQueue } from "@/components/closing/ClosingQueue";
...
// Closing-Queue: alle Closing-Calls des Workspace (personen-gescoped bei
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      ...
      >
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
            <Handshake size={18} color="var(--brand-500)" />
            <h1
              style={{
                fontSize: "1.375rem",
                fontWeight: 800,
          ...
          <p style={{ fontSize: "0.8125rem", color: "var(--text-muted)", margin: 0 }}>
            Closing-Calls aus qualifizierten Settings · Script-Runner · Abschluss
          </p>
        </div>
        <span
          style={{
      ...
      <ClosingQueue
        ...
        meId={access.effective_user_id ?? access.user.id}
      />
    </div>
  );
}
