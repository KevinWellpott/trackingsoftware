...
nicht gemergt ist. Einzig **0035** (Pflichtfeld-Trigger) ist geschrieben und
ausdrücklich **noch nicht eingespielt** — sie würde die heute produktive App
zerbrechen (§7).
...
**Noch NICHT eingespielt, mit Absicht — genau eine Datei:**
