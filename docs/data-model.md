...
|---|---|---|
| **Übersicht** | Matrix **Kennzahl × Kanal × Gesamt** (Akquise-Volumen · Settingtermine · Show-Quote · Quali-Quote · Closingtermine · Umsatz), kumulierter Verlauf des Termin-Funnels, Personen-Tabelle | der Kanalvergleich in einem Blick. **Kein Trichter** — den gibt es genau einmal, im Funnel-Tab; zwei optisch gleiche Trichter mit verschiedenen Zählweisen beschädigen beide |
| **LinkedIn** | 6 Kennzahlen (DMs · Antwortquote · Antworten mit Stimmungs-Balken · Termine gelegt · Terminquote · Block-Quote), Personen-Vergleich (nur bei mehr als einer sichtbaren Person), Verlauf, Consistency, Follow-up-Kaskade, Nachfass-Disziplin, Listen-Ranking | alle LinkedIn-Kennzahlen. Die früheren Tabs „Follow-ups" und „Listen" sind hier aufgegangen; `?tab=followup`/`?tab=listen` fällt still auf „uebersicht" zurück |
| **Telefon** | 11 Kennzahlen in drei Blöcken (Volumen · Durchkommen · Terminquoten & Rückruf), Personen-Vergleich (Personen ohne Telefon-Aktivität im Zeitraum werden ausgeblendet und in der Fußnote gezählt), Anruf-Log, Verlauf, A/B nach Skript und Branche, Gatekeeper-Weg, Versuchszähler, Abbruch-Gründe | die Ereignis-Ebene (**Anwahlen**, §1) und die A/B-Achsen |
| **Setting** | 4 Kennzahlen (Termine · Show-Quote · Qualifiziert · Zu Closing geschickt), Personen-Vergleich, Verlauf, Quellen-Donut, „Quelle des Termins"; alles Weitere unter „Mehr Auswertungen" (Zeitfenster · Termin-Art · Branche · Kriterien · Qualität · Status) | die Qualifizierungs-Schnitte |
| **Closing** | 6 Kennzahlen (Closing-Termine · Show-Quote · Abschlussrate · Umsatz/Meeting · Ø-Deal · Umsatz), Personen-Vergleich, Verlauf, Top-Einwände, Matrix Einwand × Person; „Mehr Auswertungen" (Umsatzverlauf · Win/Loss · Geschwindigkeit · Deal-Größen · Vertrag · Zahlungsarten) | Verlustgründe. **Keine Quellen-Tabelle mehr** — Herkunft rechnet der Funnel-Tab als einziger bis zum Umsatz durch |
| **Funnel** | Wert-Kacheln je Kanal, Umsatz-Herkunft, der **Trichter**, Verlauf, Matrix „Je Quelle" | der einzige Trichter und die einzige Quellen-Auswertung, die bis zum Umsatz reicht |
